                    ...
                    <div className='sm:w-[80%] p-2 mx-auto mt-4'>
                        ...
                        <form className='mt-10' onSubmit={handleSubmit}>
                            ...
                            <div className='mt-8 flex flex-col justify-center items-center  sm:flex-row gap-2 sm:gap-10 sm:items-start sm:justify-start'>
                                <img className={`rounded-full min-w-40 min-h-40 max-w-40 max-h-40 w-40 h-40 object-cover border-dashed border-2 p-1 cursor-pointer' ${formInputerror.avatarerror ? 'border-red-500' : ''}`} src={avatar} onClick={() => { document.getElementById('avatarinput').click() }} alt='' />
